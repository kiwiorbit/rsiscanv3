...
interface PriceGridCellSkeletonProps {
    animationDelay: string;
}

const PriceGridCellSkeleton: React.FC<PriceGridCellSkeletonProps> = ({ animationDelay }) => {
    return (
        <div
...
export default PriceGridCellSkeleton;
