...
interface StochGridCellSkeletonProps {
    animationDelay: string;
}

const StochGridCellSkeleton: React.FC<StochGridCellSkeletonProps> = ({ animationDelay }) => {
    return (
        <div
...
export default StochGridCellSkeleton;